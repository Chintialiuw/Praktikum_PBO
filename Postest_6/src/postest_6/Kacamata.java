...
public abstract class Kacamata {
    ...
    public static void syaratGaransi(){
        System.out.println("S&K Garansi Berlaku");
        System.out.println("[1] Coating Terlepas");
        System.out.println("[2] Bercak Minyak Tidak Bisa Hilang");
    }
