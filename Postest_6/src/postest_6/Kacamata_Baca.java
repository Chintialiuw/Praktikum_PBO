 ...
 */
public final class Kacamata_Baca extends Kacamata implements Level1 {
    ...
    public void tertampil(){
        ...
        System.out.println("Kategori Lensa        : " + kategoriLensa());
        System.out.println("Lensa Tambahan        : " + this.lensaTambahan);
        System.out.println("Merk Lensa Tambahan   : " + MerkLensaTambahan());
    ...
    @Override
    public String MerkLensaTambahan(){
        return "KAITO Blue Light Blooker";
    }
    
    @Override
    public String kategoriLensa(){
        return "Lensa Progresif";
    }
}
