...
public class Main {
    ...
    public static void tambahData() throws IOException
    {
        ...
        if (tambah == 1) 
        {
            ...
            Kacamata_Baca kcmtBca = new Kacamata_Baca(addKode, addMaterial, addNama, addWarna, addJenisLensa, addLensaTambahan, addHarga, addGaransiLensa, addGaransiFrame, addStok, "Kacamata Baca"); 
            kacamataBaca.add(kcmtBca); 
            
            kcmtBca.info(addKode, addGaransiLensa, addGaransiFrame);
            kcmtBca.tertambah();
        } 
        else if (tambah == 2)
        {
            ...
            Kacamata_Minus kcmtMns = new Kacamata_Minus(addKode1, addMaterial1, addNama1, addWarna1, addJenisLensa1, addHarga1, addGaransiLensa1, addGaransiFrame1, addBonus, addStok1, "Kacamata Minus"); 
            kacamataMinus.add(kcmtMns); 
            
            kcmtMns.info(addKode1, addGaransiLensa1, addGaransiFrame1);
            kcmtMns.tertambah();
        }
        else
        {
    ...
    public static void editData() throws IOException
    {
        ...
        if (baca_edit == 1)
        {
            ...
            if(edit <= kacamataBaca.size() || edit > 0)
            {
                ...
                kacamataBaca.get(edit-1).info(addKode);
        ...
        else if (baca_edit == 2)
        {
            ...
            if(edit1 <= kacamataMinus.size() || edit1 > 0)
            {
                ...
                kacamataMinus.get(edit1-1).info(addKode);
