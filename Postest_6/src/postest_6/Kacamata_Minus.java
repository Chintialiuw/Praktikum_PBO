...
public final class Kacamata_Minus extends Kacamata implements Level2 {
    ...
    public void tertampil(){
        ...
        System.out.println("Jenis Lensa           : " + getLensa());
        System.out.println("Ukuran Lensa          : " + this.jenisLensa);
        System.out.println("Merk Anti Radiasi     : " + getMerkAntiRadiasi());
        System.out.println("Tingkatan Lensa       : " + getTingkatanLensa());
    ...
    @Override
    public String getMerkAntiRadiasi(){
        return "Hoya Photo Grey";
    }
    
    @Override
    public String getTingkatanLensa(){
        return "UV 420";
    }
}
